...
if(isset($_POST) && !empty($_POST)){
	extract($_POST);
	$endPoint = "http://localhost/api/create-task.php";
                ...
                <form class="form-card" action="" method="POST">
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Status
                        	...
                        	<select class=""  name="status">
                        		...
                        		<option <?php if($status==='Complated'){ echo ' selected '; } ?> value="Complated">Complated</option>
                        		<option <?php if($status==='Pending'){ echo ' selected '; } ?>  value="Pending">Pending</option>
                        		<option <?php if($status==='Inprogress'){ echo ' selected '; } ?>  value="Inprogress">Inprogress</option>
                        	</select>
						 </div>
                    </div>
                    <div class="row justify-content-between text-left">
                    ...
                    <div class="row justify-content-end">
                        <div class="form-group col-sm-12">
                        	<button type="submit" class="btn-block btn-primary">Create Task</button>
                        </div>
                    </div>
                </form>
            </div>
